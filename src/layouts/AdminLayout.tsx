        ...
        <header className="w-full bg-white/90 backdrop-blur-md shadow-md px-4 py-3 flex items-center justify-between border-b border-blue-100 z-30 relative">
          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <div className="relative group">
              <button className="flex items-center gap-2 p-2 rounded-full bg-gradient-to-r from-blue-500 to-green-400 text-white font-bold shadow hover:scale-105 transition focus:ring-2 focus:ring-green-400">
              ...
              <div className="absolute right-0 mt-2 w-40 bg-white rounded-xl shadow-lg border border-blue-100 py-2 opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition z-20">
                <button onClick={() => { logout(); navigate('/login'); }} className="w-full text-left px-4 py-2 text-blue-700 hover:bg-blue-50 flex items-center gap-2">
